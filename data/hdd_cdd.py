...
df = pd.read_csv("/Users/batuhanhidiroglu/Desktop/internship/task1/task1/data/combined_power_weather_data.csv")
...
df.to_csv("/Users/batuhanhidiroglu/Desktop/internship/task1/task1/data/final_data.csv", index=False)
